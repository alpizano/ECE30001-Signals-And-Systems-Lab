...
subplot(2,2,2), plot (t1,Y1), title('y1');

%figure;
subplot(2,2,1), plot(t1,X2),title('x2');
subplot(2,2,2), plot (t1,Y2), title('y2');
%pause(2)
%close all
...
Y3=sys_resp(X3);
YN=3*Y1+4*Y2;
subplot(3,1,1), plot(t1,X3),title('x3(t)');
grid on
subplot(3,1,2), plot (t1,Y3), title('y3(t)');
grid on
subplot(3,1,3), plot(t1,YN), title('yN(t)');
grid on 
